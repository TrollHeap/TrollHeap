...
> L3 Informatique — CNAM. NSY103 (kernel/system Linux). UTC502.
----------------
  ▸ OS    : Fedora Linux · RHEL · Rocky Linux · NixOS
  ▸ WM    : Hyprland (Wayland)
  ▸ Shell : Bash 5 + ble.sh · Zsh
  ▸ Edit  : Neovim · tmux + tmuxifier
  ▸ Lang  : Rust · C · Bash · PHP 8.4 · TypeScript · Python
